...
public class GpsUtils
{
    ...
    public static void Test2()
    {
		...
		double xEast, yNorth, zUp;
        EcefToEnu(x0, y0, z0, latLA, lonLA, hLA, out xEast, out yNorth, out zUp);
		...
		double latTest, lonTest, hTest;
        EnuToEcef(xEast, yNorth, zUp, latLA, lonLA, hLA, out xTest, out yTest, out zTest);
        EcefToGeodetic(xTest, yTest, zTest, out latTest, out lonTest, out hTest);
